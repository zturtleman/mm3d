...
#ifndef __SELECTPROJTOOL_H
#define __SELECTPROJTOOL_H
...
class SelectProjectionTool : public Tool
{
   public:
      SelectProjectionTool();
      virtual ~SelectProjectionTool();
