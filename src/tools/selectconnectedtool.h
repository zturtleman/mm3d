...
#ifndef __SELECTCONNECTEDTOOL_H
#define __SELECTCONNECTEDTOOL_H
...
class SelectConnectedTool : public Tool
{
   public:
      SelectConnectedTool();
      virtual ~SelectConnectedTool();
